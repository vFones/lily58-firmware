 ...
 */
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_LBRC,        KC_RBRC,    KC_N,   KC_M,   TD(0),      KC_BACKSLASH,   KC_SLSH,    KC_RCTL,
                                KC_LALT, KC_LGUI, LRAISE,    KC_SPC,         KC_ENT,      KC_BSPC, RAISE, KC_RGUI
    ),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
    [_RAISE] = LAYOUT(
      ...
      _______,  KC_MPRV,    KC_MNXT,    KC_MPLY,    KC_MUTE,    _______, _______,               _______,    KC_END,     KC_PGDN,    KC_PGUP,    KC_HOME, _______,   KC_F14,
